...
#   GPIO  8 (pin 24) = CE0   ->  receiver CS   (driven automatically by the driver)
...
#   then reboot. The device appears as /dev/spidev0.0 (bus 0, CE0).
#
...
def spi_thread():
    ...
    spidev.xfer2() holds CE0 LOW for the whole 2-byte block, so the
