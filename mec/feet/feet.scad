...
{   
    ...
    {
        cube_r(40,40,8,4);
        translate([0,0,75])rotate([0,0,0])cube([60,60,5]);
    }
...
module minus()
{
    translate([30,30,40])rotate([0,0,0])cylinder(50,6.5/2,6.5/2);
    
    
    translate([30,30,72])rotate([0,0,0])cylinder($fn = 6,5.5,12/2,12/2);
