...
module plus()
{   
   translate([0,0,0])rotate([0,0,0])cube([80,180,8],true);  // Base
   // translate([10,0,0])rotate([0,90,0])cylinder(40,20/2,19.7/2);
   hull()
   {
       translate([40,60,0])rotate([0,-90,0])cylinder(80,0.1/2,0.1/2);
       translate([40,-60,0])rotate([0,-90,0])cylinder(80,0.1/2,0.1/2);
       
       translate([40,20,160])rotate([0,-90,0])cylinder(80,4/2,4/2);
       translate([40,-20,160])rotate([0,-90,0])cylinder(80,4/2,4/2);
   }
...
module minus()
{
    translate([40-10,0,145])rotate([0,90,0])cylinder(10,22/2,22/2); // Lager 
    translate([-40,0,145])rotate([0,90,0])cylinder(10,22/2,22/2);   // Lager
    
    translate([-40,0,145])rotate([0,90,0])cylinder(80,10/2,10/2);  // Achse
    
    translate([0,0,120])rotate([0,0,0])cube([25,200,100],true); // Aussparung in der Mitte
    
   translate([40-20,(200/2-60)/2+60,-4])rotate([0,0,0])cylinder(8,5/2,5/2);  // Schraubenlöcher
   translate([-20,(200/2-60)/2+60,-4])rotate([0,0,0])cylinder(8,5/2,5/2);
   translate([40-20,-(200/2-60)/2-60,-4])rotate([0,0,0])cylinder(8,5/2,5/2);
   translate([-20,-(200/2-60)/2-60,-4])rotate([0,0,0])cylinder(8,5/2,5/2);
